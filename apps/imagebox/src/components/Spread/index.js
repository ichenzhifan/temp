...
class Spread extends Component {
   ...
   */
  getPhotoElementHtml() {
    const { spreadId, spreadOptions, ratio, toggleOperationPanel, getImageDetail } = this.props;
    const { width, height } = spreadOptions;
  ...
  handleBgClick(event) {
    ...
    const { boundWorkspaceActions, spreadId, spreadOptions } = this.props;
