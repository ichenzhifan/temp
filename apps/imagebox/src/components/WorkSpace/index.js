...
class WorkSpace extends Component {
   ...
   */
  onRotateImage(ev) {
    const { boundWorkspaceActions, imageArray } = this.props;
  ...
  getSpreadHtml() {
    ...
    const { baseUrls, imageArray, boundProjectActions, boundUploadedImagesActions, boundWorkspaceActions, toggleModal, editText, getImageDetail, ratio } = this.props;
