import { CHANGE_WORKSPACE_SPREAD, AUTO_ADD_PHOTO_TO_CANVAS, TOGGLE_OPERATION_PNAEL, UPDATE_WORKSPACE_SPREADS, IN_PREVIEW_WORKSPACE } from '../contants/actionTypes';
 ...
 */
export function autoAddPhotoToCanvas(status, spreadId, targetWidth, targetHeight) {
  return {
