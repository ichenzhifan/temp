...
class MultipleActionPanel extends Component {
  ...
  alignPosition(method) {
    ...
    actions.updateElementPosition(newSelectedElementArray);
  }
  ...
  matchSize(selectedElementArray, sizeObject) {
    ...
    actions.updateElementSize(newSelectedElementArray);
  }
  ...
  render() {
    ...
    const multipleActionPanelStyle = {
    ...
    return (
      <div
        ...
        style={multipleActionPanelStyle}
...
MultipleActionPanel.propTypes = {
  ...
  actions: PropTypes.shape({
    updateElementSize: PropTypes.func.isRequired,
