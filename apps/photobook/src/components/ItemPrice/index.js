...
import { elementTypes, FREE, productTypes, coverTypes } from '../../contants/strings';
...
class ItemPrice extends Component {
  ...
  constructor(props) {
    ...
    this.lostPopupFocus = () => handler.lostPopupFocus(this);
  }
  ...
  renderDetail(main, options) {
    ...
    const { parameters, allSheets, allElements, settings } = data;
