...
class SheetsList extends Component {
  ...
  render() {
    ...
    const listStyle = {
      ...
      height: pagination.sheetIndex === 0 ? size.renderCoverSize.height + 'px' : size.renderInnerSize.height + 'px'
    };
    ...
    return (
     <div className="spreads-list" style={listStyle}>
        <div className="pages-list" style={ulStyle}>
          ...
          >
             <SheetRender key={sheetIndex} actions={sheetRenderActions} data={sheetRenderData}/>
          </ReactCSSTransitionGroup>
        </div>
      </div>
    );
